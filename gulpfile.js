...
gulp.task('style', gulp.parallel('css-main','css-vendor','copy-fonts'))
...
////minify all js files and css files
gulp.task('script', gulp.parallel('js-vendor', 'js-main'));

gulp.task('prod', gulp.parallel('style','script'));
